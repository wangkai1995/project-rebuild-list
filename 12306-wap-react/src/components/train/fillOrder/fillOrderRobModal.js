...
class TrainfillOrderRobModal extends Component {
    ...
    render(){
        const { isModal ,childrenLen ,adultLen ,ticketPrice ,insurancePrice ,robHandleFee ,robPack  } = this.props;
        if(!isModal){
            return null;
        }
        return(
            <Popup prefix="fillOrder">
                <ul styleName="footer-popup-detail">
                    ...
                    <li styleName="popup-item">
                     ...
                     <li styleName="popup-item">
                        <div styleName="item-col-left left">抢票加速包</div>
                        <div styleName="item-col-right money">¥{robPack.packPrice}</div>
                    </li>
                </ul>
            </Popup>
        );
...
export default  TrainfillOrderRobModal;
