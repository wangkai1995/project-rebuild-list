...
import BusfillOrderCommonModal from './fillOrderCommonModal';
import BusfillOrderBuy12306Modal from './fillOrderPublic12306Buy';


@immutableRenderDecorator
@CSSModules(_.merge({},styles,icon),{allowMultiple: true})
class BusfillOrderPublicFooter extends Component {
	...
	render(){
		...
		return(
			<div styleName="order-footer">
                ...
                <BusfillOrderBuy12306Modal loading={loading} onBuySubmit={onBuySubmit} onCancel={this.handleBuyModalHide} isBuyModal={isBuyModal}  />
			</div>
		);
	}	
}
...
export default  BusfillOrderPublicFooter;
